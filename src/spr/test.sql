\if :test
    create function tests.startup_spr() returns setof text as $$
    begin
    ...
    create function tests.shutdown_spr() returns setof text as $$
    begin
    ...
    create function tests.session_as_admin() returns jsonb as $$
    declare
        a jsonb;
    begin
